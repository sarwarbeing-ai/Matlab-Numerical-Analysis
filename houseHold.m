% since the .txt file is not available therefore I will use the data you
% have provided 
% to use your data do the following
% data=importdata('crime.txt'); % uncomment this line and delete the data
% matrix below
...
% extract house values (third column)
House_values=data(:,3);

% extract crime(first column)
crime=data(:,1);
...
% plot
subplot(1,2,1) % 1 row two columns ,third argument is the index of the current axe
scatter(House_values,crime,'MarkerEdgeColor','k','MarkerFaceColor','b')
xlabel("House Values")
ylabel("Crime")
title("Crime versus House Values")

subplot(1,2,2) % second subplot
scatter(household_income,crime,'MarkerEdgeColor','k','MarkerFaceColor','r')

xlabel("Household Income")
ylabel("Crime")
title("Crime versus Household Income")
